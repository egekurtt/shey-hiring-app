  ...
  return (
    <div className='mt-10 flex flex-col gap-10 mb-10'>
      ...
      <div className='flex gap-5 flex-col'>
        <h1 className='text-center text-3xl font-semibold text-primary'>What we do ?</h1>
        ...
        <div className='relative'>
            ...
            <div className='absolute inset-0 bg-black opacity-70 flex items-center justify-center rounded-2xl'>
